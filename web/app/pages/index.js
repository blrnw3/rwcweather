...
function LiveTime(props) {
  ...
  let icon = isLoading ? <Spinner mr="3" size="sm" speed="1s" color={status} /> : <IconContext.Provider value={{ color: status, size: "1.5em", style: {display: "inline"} }} >
...
function WindHomeCard(props) {
  ...
  return <HomeCard changed={changed}>
      <Text>
        <IconContext.Provider value={{ color: "brown", size: "2em", style: {display: "inline", paddingRight: "5px"} }} ><FiWind /></IconContext.Provider>
...
export default function Home() {
  ...
  return <Page name="home" title="RWC Weather | Dashboard"><HomePage live={{}} /></Page>;
}
