...
export default function About() {
    ...
    return (
      <Page>
        ...
        <Text>
            The station sits approximately ~125 m (420 ft) above sea level, in the small community of Emerald Lake Hills in the heart of the San Francisco bay area in northern California.
            We are sandwiched between the busy bayside town of Redwood City and the peaceful town of Woodside which lies in the low foothills of the northern potion of the Santa Cruz mountains.
            The SF bay area is famous for its microclimates and here is no exception. Sitting towards the top of the Emerald Hills canyon, we experience milder nights than the valley floor and a degree of protection from the prevailing westerly winds.
        </Text>
