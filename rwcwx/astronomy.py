# MODIFIED FROM https://github.com/Broham/suncalcPy/blob/master/suncalc.py
...
def getTimes(date, lat, lng):
    ...
    daylight_dt = datetime.fromtimestamp(0) + daylight
    result["daylight_fmt"] = f"{daylight_dt.hour:02}h {daylight_dt.minute:02}m"
    result["daylight_secs"] = daylight.seconds
    return result
